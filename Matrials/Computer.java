...
public class Computer {
    ...
    public static boolean Swap(int last_positionX,int last_positionY,int validplaceX,int validplaceY,int i ,int k, boolean function) {
        ...
        if (i < 8) {
            ...
            if (CheckMate.Pawn_WhiteChecked((int) Game.W_King_Pos.getY(), (int) Game.W_King_Pos.getX(), (i * -1) - 1, i)) {
        ...
        // Knight
            ...
            if (CheckMate.Knight_WhiteChecked((int) Game.W_King_Pos.getY(), (int) Game.W_King_Pos.getX(), board.piece[Knight.lastPosition[i - 8].x][Knight.lastPosition[i - 8].y], i - 8)) {
        ...
        // Rock
            ...
            if (CheckMate.Rock_WhiteChecked((int) Game.W_King_Pos.getY(), (int) Game.W_King_Pos.getX(), board.piece[Rock.lastPosition[i - 10].x][Rock.lastPosition[i - 10].y], i - 10)) {
                ArrayOf(function, 5, i, k);
                effect = true;
            }
        ...
        // Bishop
            ...
            if (CheckMate.Bishop_WhiteChecked((int) Game.W_King_Pos.getY(), (int) Game.W_King_Pos.getX(), board.piece[Bishop.lastPosition[i - 12].x][Bishop.lastPosition[i - 12].y], i - 12)) {
                ArrayOf(function, 5, i, k);
                effect = true;
            }
        ...
        // Queen
            ...
            if (CheckMate.Queen_WhiteChecked((int) Game.W_King_Pos.getY(), (int) Game.W_King_Pos.getX(), board.piece[Queen.lastPosition[0].x][Queen.lastPosition[0].y], 0)) {
                ArrayOf(function, 5, i, k);
                effect = true;
            }
            ...
            if (Pawn.counter != 0) {
                for (int k = 0; k < Pawn.counter; k++) {
                    if (Pawn.ValidPlacesX[k] != -1 && Pawn.ValidPlacesY[k] != -1) {
                        if (Swap(Pawn.lastPosition[i].x, Pawn.lastPosition[i].y, Pawn.ValidPlacesX[k], Pawn.ValidPlacesY[k], i, k, function)) {
                        }
                        else if (board.piece[Pawn.ValidPlacesX[k]][Pawn.ValidPlacesY[k]] == 12 || board.piece[Pawn.ValidPlacesX[k]][Pawn.ValidPlacesY[k]] == 13) {
            ...
            if (Knight.counter != 0) {
                for (int k = 0; k < Knight.counter; k++) {
                    if (Knight.ValidPlacesX[k] != -1 && Knight.ValidPlacesY[k] != -1) {
                        ...
                        else if (board.piece[Knight.ValidPlacesX[k]][Knight.ValidPlacesY[k]] == 12 || board.piece[Knight.ValidPlacesX[k]][Knight.ValidPlacesY[k]] == 13) {
                            ArrayOf(function, 4, i, k);
                        }
            ...
            if (Rock.counter != 0) {
                for (int k = 0; k < Rock.counter; k++) {
                    if (Rock.ValidPlacesX[k] != -1 && Rock.ValidPlacesY[k] != -1) {
                        if (Swap(Rock.lastPosition[i - 10].x, Rock.lastPosition[i - 10].y, Rock.ValidPlacesX[k], Rock.ValidPlacesY[k], i, k, function)){
                            System.out.println("swap");
                        }
                        else if (board.piece[Rock.ValidPlacesX[k]][Rock.ValidPlacesY[k]] == 12) {
                            ArrayOf(function, 4, i, k);
                        }
            ...
            if (Bishop.counter != 0) {
                for (int k = 0; k < Bishop.counter; k++) {
                    if (Bishop.ValidPlacesX[k] != -1 && Bishop.ValidPlacesY[k] != -1) {
                        if (Swap(Bishop.lastPosition[i - 12].x, Bishop.lastPosition[i - 12].y, Bishop.ValidPlacesX[k], Bishop.ValidPlacesY[k], i, k, function)){
                            System.out.println("swap");
                        }
                        else if (board.piece[Bishop.ValidPlacesX[k]][Bishop.ValidPlacesY[k]] == 12 || board.piece[Bishop.ValidPlacesX[k]][Bishop.ValidPlacesY[k]] == 13) {
                            ArrayOf(function, 4, i, k);
                        }
            ...
            if (Queen.counter != 0) {
                for (int k = 0; k < Queen.counter; k++) {
                    if (Queen.ValidPlacesX[k] != -1 && Queen.ValidPlacesY[k] != -1) {
                        if (Swap(Queen.lastPosition[0].x, Queen.lastPosition[0].y, Queen.ValidPlacesX[k], Queen.ValidPlacesY[k], i, k, function)){
                            System.out.println("swap");
                        }
                        else if (board.piece[Queen.ValidPlacesX[k]][Queen.ValidPlacesY[k]] == 12 || board.piece[Queen.ValidPlacesX[k]][Queen.ValidPlacesY[k]] == 13) {
                            ArrayOf(function, 4, i, k);
                        }
            ...
            if (King.counter != 0) {
                for (int k = 0; k < King.counter; k++) {
                    if (King.ValidPlacesX[k] != -1 && King.ValidPlacesY[k] != -1) {
                          if (board.piece[King.ValidPlacesX[k]][King.ValidPlacesY[k]] == 12 || board.piece[King.ValidPlacesX[k]][King.ValidPlacesY[k]] == 13) {
                            ArrayOf(function, 4, i, k);
                        }
