...
public class Promotion extends MouseAdapter implements MouseMotionListener {
    ...
    static Image backGround = Toolkit.getDefaultToolkit().getImage("src\\Backgrounds\\promotion_options.jpg");
    static Image backGround1 = Toolkit.getDefaultToolkit().getImage("src\\Backgrounds\\Promotion black.png");

    // pawn promotion
    public  static boolean PawnPromotion(int p2X, int type) {
        // white pawn
        if(type > 0 && type < 9 && p2X == 0)  {
            promotion_options.setContentPane(new JLabel(new ImageIcon(backGround)));
            Game.black = false;
        ...
        // black pawn
            ...
            promotion_options.setContentPane(new JLabel(new ImageIcon(backGround1)));
            Game.black = true;
    ...
    public static void PromotionToKnight(int p2X, int p2Y, int type) {
        ...
        if(type > 0 && type < 9) {
            ...
            if(Knight.lastPosition[2].x == 100 && Knight.lastPosition[2].y == 100) {
                ...
                Display.Game.add(Game.knight[2].label);
            }
                ...
                Display.Game.add(Game.knight[3].label);
            }
            // If not
            else {
                ...
                Display.Game.add(Game.knight[4 + Knight.promotion_counter_W].label);
        ...
        //promotion black knight
            ...
            if(Knight.lastPosition[0].x == 100 && Knight.lastPosition[0].y == 100) {
                ...
                Display.Game.add(Game.knight[0].label);
            }
                ...
                Display.Game.add(Game.knight[1].label);
            }
            // If not
            else {
                ...
                Display.Game.add(Game.knight[12 + Knight.promotion_counter_B].label);
    ...
    public static void PromotionToBishop(int p2X, int p2Y, int type) {
        ...
        if (type > 0 && type < 9) {
            ...
            if (Bishop.lastPosition[2].x == 100 && Bishop.lastPosition[2].y == 100) {
                ...
                Display.Game.add(Game.bishop[2].label);
                ...
                Display.Game.add(Game.bishop[3].label);
            }
            // If not
            else {
                ...
                Display.Game.add(Game.bishop[4 + Bishop.promotion_counter_W].label);
        ...
        //promotion black bishop
            ...
            if (Bishop.lastPosition[0].x == 100 && Bishop.lastPosition[0].y == 100) {
                ...
                Display.Game.add(Game.bishop[0].label);
                ...
                Display.Game.add(Game.bishop[1].label);
            }
            // If not
            else {
                ...
                Display.Game.add(Game.bishop[12 + Bishop.promotion_counter_B].label);
    ...
    public static void PromotionToQueen(int p2X, int p2Y, int type) {
        ...
        if (type > 0 && type < 9) {
            ...
            if (Queen.lastPosition[1].x == 100 && Queen.lastPosition[1].y == 100) {
                ...
                Display.Game.add(Game.queen[1].label);
            } else {
                ...
                Display.Game.add(Game.queen[2 + Queen.promotion_counter_W].label);
        ...
        //promotion black bishop
            ...
            if (Queen.lastPosition[0].x == 100 && Queen.lastPosition[0].y == 100) {
                ...
                Display.Game.add(Game.queen[0].label);
            } else {
                ...
                Display.Game.add(Game.queen[10 + Queen.promotion_counter_B].label);
    ...
    public static void PromotionToRock(int p2X, int p2Y, int type) {
        ...
        if (type > 0 && type < 9) {
            ...
            if (Rock.lastPosition[2].x == 100 && Rock.lastPosition[2].y == 100) {
                ...
                Display.Game.add(Game.rock[2].label);
                ...
                Display.Game.add(Game.rock[3].label);
            }
            // If not
            else {
                ...
                Display.Game.add(Game.rock[4 + Rock.promotion_counter_W].label);
        ...
        //promotion black bishop
            ...
            if (Rock.lastPosition[0].x == 100 && Rock.lastPosition[0].y == 100) {
                ...
                Display.Game.add(Game.rock[0].label);
                ...
                Display.Game.add(Game.rock[1].label);
            }
            // If not
            else {
                ...
                Display.Game.add(Game.rock[12 + Rock.promotion_counter_B].label);
